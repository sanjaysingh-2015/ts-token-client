...
public class DepartmentController {
    ...
    public ResponseEntity<IApiResponse> createDepartment(@PathVariable("org-code") String orgCode,@RequestBody @Valid DepartmentCreateRequestPayload requestPayload) {
    ...
    public ResponseEntity<IApiResponse> getOrganizationList(@PathVariable("org-code") String orgCode) {
