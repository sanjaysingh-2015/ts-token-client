...
public class JwtUtils {
  ...
  public String getJwtFromCookies(HttpServletRequest request) {
    ...
    if (cookie != null) {
      ...
      String authorization = request.getHeader("Authorization").substring(20);
      if(authorization.contains("Path")) {
        authorization = authorization.substring(0, authorization.indexOf("Path") - 1);
